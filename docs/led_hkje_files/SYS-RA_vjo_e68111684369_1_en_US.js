...
var _d=new vjo.dsf.Message("RTM_COMPLETE");_d.status=1;_d.vjRTMObject=t;t.S.handleRequest(_d);if(_8){_d=new vjo.dsf.Message("PROMO_COMPLETE");_d.vjPromoClientObject=t;t.S.handleRequest(_d);}},TimedOut:function(){var t=this;t.bRespRet=true;if(t.bTimedOut){return true;}
...
var _39=t.oJSBean;var i=t.getIndex(pAd.id);var id=t.ids[i];var _3c=t.E.get(id);var url=_39.dblclkUrls[i];if(!url){return;}
if(t.getStatus(id)){return;}
if(_3c&&!_3c.length){t.addStatus(id,true);if(pAd.content!=""){url+=pAd.content+";";}
url+="ord="+t.iOrd;_3c.innerHTML=t.createIframe(id,url,_39.heights[i],_39.widths[i]);_3c.style.display="block";}else{t.addStatus(id,false);}},processNoneAd:function(pAd){var t=this;var _40=t.oJSBean;var i=t.getIndex(pAd.id);var id=t.ids[i];var _43=t.E.get(id);var _44=_40.defaultUrls[i];if(t.getStatus(id)){return;}
if(_43&&!_43.length){t.addStatus(id,true);if(!_44||_44=="collapse"||_44==""){_43.style.height="0px";_43.style.display="none";}else{_43.innerHTML=t.createIframe(id,_44,_40.heights[i],_40.widths[i]);}}else{t.addStatus(id,false);}},processHTMLAd:function(pAd){var t=this;if(pAd.height=="-1"||pAd.height=="9999"){pAd.height="auto";}
if(pAd.width=="-1"||pAd.width=="9999"){pAd.width="auto";}
var i=t.getIndex(pAd.id);var id=t.ids[i];var _49=t.E.get(id);if(t.getStatus(id)){return;}
if(_49&&!_49.length){t.addStatus(id,true);var _4a=_49.style,h,w;_4a.height=h=(pAd.height.indexOf("auto")!=-1)?pAd.height:pAd.height+"px";_4a.width=w=(pAd.width.indexOf("auto")!=-1)?pAd.width:pAd.width+"px";if((w!="auto")&&(h!="auto")){if(pAd.expand){_4a.textAlign="left";}else{_4a.overflow="hidden";}}
_49.innerHTML=pAd.content;_49.style.display="block";t.executeScripts(pAd.content);}else{t.addStatus(id,false);}},executeScripts:function(_4b){var m,ns,re=/<script\b[\s\S]*?>([\s\S]*?)<\/script>/ig;while(m=re.exec(_4b)){this.vj$.JsLoader.loadText(m[1]);}},processHTMLFormAd:function(pAd){var t=this;if(pAd.height=="-1"||pAd.height=="9999"){pAd.height="auto";}
if(pAd.width=="-1"||pAd.width=="9999"){pAd.width="auto";}
var i=t.getIndex(pAd.id);var id=t.ids[i];var _53=t.E.get(id);if(t.getStatus(id)){return;}
if(_53&&!_53.length){t.addStatus(id,true);var _54=_53.style,h,w;_54.height=h=(pAd.height.indexOf("auto")!=-1)?pAd.height:pAd.height+"px";_54.width=w=(pAd.width.indexOf("auto")!=-1)?pAd.width:pAd.width+"px";if(h!="auto"&&w!="auto"){_54.overflow="hidden";}
var f=document.createElement("iframe");f.setAttribute("hspace",0);f.setAttribute("vspace",0);f.setAttribute("width","100%");f.setAttribute("frameBorder",0);f.setAttribute("scrolling","no");f.setAttribute("marginWidth",0);f.setAttribute("marginHeight",0);_53.appendChild(f);f.doc=null;if(f.contentDocument){f.doc=f.contentDocument;}else{if(f.contentWindow){f.doc=f.contentWindow.document;}else{if(f.document){f.doc=f.document;}}}
if(f.doc==null){throw"RTM002";}
f.doc.open();try{f.doc.write(pAd.content);}
finally{f.doc.close();}}else{t.addStatus(t.ids[i],false);}},getUIElement:function(_56){var s=_56,d=window.document;if(d.getElementById){return d.getElementById(s);}else{if(d.all){return d.all(s);}}
return null;},getIndex:function(pId){var t=this,ids=t.oJSBean.htmlIds,l=t.oJSBean.htmlIds.length;for(var i=0;i<l;i++){if(ids[i]==("rtm_html_"+pId)){return i;}}},createIframe:function(pId,_5c,_5d,_5e){var _5f="ifrm_"+pId;var f="<iframe frameborder=\"no\" border=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\""+" id=\""+_5f+"\""+" name=\""+_5f+"\""+" src=\""+_5c+"\""+" width=\""+_5e+"\" height=\""+_5d+"\"></iframe>";return f;},appendUrl:function(_61){this.oJSBean.url+=_61;},processGlobalNavPids:function(_62){var t=this,sParams="",oGlobalNav;if(typeof(_oGlobalNavRTMInfo)!="undefined"){oGlobalNav=_oGlobalNavRTMInfo;t.aGlbNavPlac=oGlobalNav.aRTMPlacementData;}
...
var len=t.aGlbNavPlac.length;for(var i=0;i<len;i++){var _68=t.ids.length;var p=t.aGlbNavPlac[i];t.ids[_68]=(p.htmlId)?p.htmlId:"glbl_nav_no_html_id";b.pids[_68]=(p.pid)?p.pid:"glbl_nav_no_pid";b.heights[_68]=(p.maxHeight)?p.maxHeight:"glbl_nav_no_height";b.widths[_68]=(p.maxWidth)?p.maxWidth:"glbl_nav_no_width";b.dblclkUrls[_68]=(p.dblclkUrl)?p.dblclkUrl:"glbl_nav_no_dblclk";b.defaultUrls[_68]=(p.defaultUrl)?p.defaultUrl:"collapse";if(p.renderBeforeOnload&&b.quickPids){b.quickPids[b.quickPids.length]=p.pid;}}},setTimeOut:function(){var t=this;if(!t.bRespRet){var _6b=function(){t.processTimeOut();};t.oTimeoutId=window.setTimeout(_6b,t.iTIMEOUT);}},processTimeOut:function(){var t=this;t.bTimedOut=true;var _6d=t.oJSBean;var _6e=_6d.defaultUrls.length;for(var i=0;i<_6e;i++){var id=t.ids[i];var _71=t.E.get(id);var _72=_6d.defaultUrls[i];if(t.getStatus(id)){continue;}
...
var _73=Math.random();if(_73<0.05){var u=_6d.url;var i=u.indexOf("&");u=u.substring(0,i);u=u+"&p="+_6d.pids.join(":")+"&ite=2&to="+t.iTIMEOUT;u=u.replace("RtmCmd","RtmIt");this.vj$.JsLoader.load(u);}
window.clearTimeout(t.oTimeoutId);var _75=new vjo.dsf.Message("RTM_COMPLETE");_75.status=0;_75.vjRTMObject=t;t.S.handleRequest(_75);},getBrowserWidth:function(){var b=this.oClient;var _77=document.body.clientWidth;if(!b.bIE){_77=window.innerWidth;}
return _77;},popUp:function(_78,_79,_7a,_7b,_7c,_7d,_7e,_7f,_80,_81,_82,_83){var s="";s+=(_7a!=null)?",width="+_7a:"";s+=(_7b!=null)?",height="+_7b:"";s+=(_7f!=null)?",screenX="+_7f+",left="+_7f:"";s+=(_80!=null)?",screenY="+_80+",top="+_80:"";s+=",toolbar="+((_7d)?"1":"0");s+=",location="+((_81)?"1":"0");s+=",status="+((_7c)?"1":"0");s+=",scrollbars="+((_7e)?"1":"0");s+=",resizable="+((_82)?"1":"0");s+=",menubar="+((_83)?"1":"0");if(s.length>0){s=s.substring(1);}
window.open(_79,_78,s);return false;},getSegment:function(_85){var oCJ=this.vj$.VjCookieJar,e=oCJ.readCookie("etfc"),r=oCJ.readCookie("reg"),s=oCJ.readCookie("ebay","sin"),c,n;if(e=="0"){n="3";c="E";}else{if(e=="1"){n="4";c="C";}else{if(e=="2"){n="5";c="D";}else{if((e==""&&(r!=""&&r!=";"))||s=="in"||e=="5"){n="2";c="B";}else{n="1";c="A";}}}}
return _85?c:n;},getCIDCookie:function(){var oCJ=this.vj$.VjCookieJar;var cid=oCJ.readCookie("npii","cguid");if(cid!="undefined"&&cid!=""){return cid;}},openReportAd:function(_89,_8a,_8b,_8c,_8d,_8e,_8f,_90,_91,_92,_93,_94,_95,_96){var t=this;if(t.globalAdOverlay==null){t.globalAdOverlay=new vjo.darwin.core.rtm.ReportAd(_8b,_8c,_8d,_8e,_91,_92,_8a,_93,_94,_95,_96);}
if(t.globalAdOverlay!=null){t.globalAdOverlay.init(_8f,_90);t.globalAdOverlay.open(_89);t.globalAdOverlay.setReportAdLinkId(_96);}
document.getElementById("startOfLayer").focus();},closeReportAd:function(){if(this.globalAdOverlay!=null){if(this.globalAdOverlay){this.globalAdOverlay.close();}}},submitReportAd:function(){if(this.globalAdOverlay!=null){if(this.globalAdOverlay){this.globalAdOverlay.submitReport();}}},yahooAdBckGrnd:function(_98){var f=this.E.get(_98);f.style.visibility="visible";f.parentNode.style.backgroundColor="transparent";},addStatus:function(_9a,_9b){this.renderedStatus[_9a]=_9b;},getStatus:function(_9c){return this.renderedStatus[_9c];},storeResponse:function(_9d){var t=this,c=_9d,qp;t.response=c;t.aContent=c;t.iContentLen=c.length;if(t.bodyLoadedTime>0){t.setInlineContent(c);}else{if(!t.TimedOut()){qp=t.oJSBean.quickPids;if(qp&&qp.length>0){t.renderPromos(qp);}}}
if(_9d!=null){for(var i=0;i<_9d.length;i++){if(_9d[i]!=null&&_9d[i].content!=null&&_9d[i].content.indexOf("openReportAd")>0){t.addReportAdScript();break;}}
if(!t.renderCSS){for(var i=0;i<_9d.length;i++){var _a0=_9d[i];if(_a0.CSSMetaData){t.renderCSS=true;t.processCSS(_a0.CSSMetaData);}}}}
if(_9d!=null&&_9d.indexOf("openReportAd")>0){t.addReportAdScript();}},addReportAdScript:function(){try{if(this.oJSBean.reportAdJsUrl){this.vj$.JsLoader.load(this.oJSBean.reportAdJsUrl);}}
catch(er){}},render:function(){var t=this,r=t.response;if(r){t.setInlineContent(r);}
t.bodyLoadedTime=(new Date()).getTime();},processPromo:function(_a2){with(this){if(_a2.type=="doubleclick"){processDoubleClickAd(_a2);}else{if(_a2.type=="html"){processHTMLAd(_a2);}else{if(_a2.type=="popUnder"){processPopUnderAd(_a2);}else{if(_a2.type=="promo"){bHasPromo=true;processPromoResponse(_a2);}else{if(_a2.type=="htmlform"){processHTMLFormAd(_a2);}else{processNoneAd(_a2);}}}}}}},renderPromos:function(_a3){var r=this.response,i,j;if(r){for(j=0;j<r.length;j++){for(i=0;i<_a3.length;i++){if(r[j].id==_a3[i]+""){this.processPromo(r[j]);}}}}},getPids:function(_a5){var p="";var l=_a5.length;for(i=0;i<l;i++){p+=_a5[i];if(i!=(l-1)){p+=":";}}
return p;},timer:function(_a8,_a9,_aa){var c=(new Date()).getTime()-oGaugeInfo.iST;var m=_aa,v=this.ssGaugeVectors,i;v[m]=v[m]||{};v[m].t=_a9;if(_a8){v[m].e=c;}else{v[m].s=c;}
var a=[];for(i in v){if(v[i].t==_a9){a.push(i+"|"+v[i].s+"|"+(v[i].e||""));}}
vjo.dsf.utils.SiteSpeed.addParam("ctr"+_a9+"v",a.join(","));}}).props({siteCatalyst:function(_ae,_af,p,_b1){var esc=vjo.darwin.tracking.sitecatalyst;if(esc){var _b3="Search",loc="North";if(p==188||p==570){_b3="Browse";}
if(p==569||p==570){loc="Sky";}
var s=esc.EbaySiteCatalyst.s;s.linkTrackVars="prop27";s.linkTrackEvents="None";s.prop27=_af+":"+_b3+":"+p+":"+_b1;if(_ae){s.linkTrackVars="prop28";s.prop28=s.prop27;s.prop27=null;}
...
// en_US/e681/SYS-RA_vjo_e68111684369_1_en_US
// b=11684369
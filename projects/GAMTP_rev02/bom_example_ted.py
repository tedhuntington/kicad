...
bomtitle=re.sub("\.sch","", ntpath.basename(net.getSource()))
# Output a set of rows for a header providing general information
html = html.replace('<!--BOMTITLE-->', bomtitle )
#html = html.replace('<!--SOURCEFILE-->', net.getSource())
html = html.replace('<!--SOURCEFILE-->','')
html = html.replace('<!--TITLE-->', bomtitle )
...
#    row += re.sub(r"TED_|ted_","",c.getFootprint()) + "</td><td>" + c.getDatasheet() + "</td><td>"
    row += re.sub(r"TED_|ted_","",c.getFootprint()) 
